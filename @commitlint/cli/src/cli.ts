 ...
 * @see https://github.com/nholuongut/commitlint/pull/3850#discussion_r1472251234
 */
			...
			errors: [
				{
					...
					message: [
						...
						'    - Example config: https://github.com/nholuongut/commitlint/blob/master/%40commitlint/config-conventional/src/index.ts',
					].join('\n'),
				},
			],
			warnings: [],
...
function getEditValue(flags: CliFlags) {
	...
	// See https://github.com/nholuongut/commitlint/issues/103 for details
