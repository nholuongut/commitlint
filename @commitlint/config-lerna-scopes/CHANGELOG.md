...
- **config-lerna-scopes:** fix package list get with recent lerna versions ([8f35dae](https://github.com/nholuongut/commitlint/commit/8f35dae))
...
- **config-lerna-scopes:** support non-standard lerna repos ([71fc40e](https://github.com/nholuongut/commitlint/commit/71fc40e))
...
- **config-lerna-scopes:** support non-standard lerna repos ([903df4b](https://github.com/nholuongut/commitlint/commit/903df4b))
