...
* **prompt:** prompt does not respect [body-leading-blank] setting ([#4066](https://github.com/nholuongut/commitlint/issues/4066)) ([3f1f44d](https://github.com/nholuongut/commitlint/commit/3f1f44d9cbb93438d01cfd79f9b71659411e126d))
...
* **cli:** print-config now can be configured to print a json in stdout ([#3863](https://github.com/nholuongut/commitlint/issues/3863)) ([6381a2d](https://github.com/nholuongut/commitlint/commit/6381a2daa0d5d89ab2195998d63a9690a533d3f2)), closes [#3819](https://github.com/nholuongut/commitlint/issues/3819)
...
* **config-nx-scopes:** support latest nx version ([#3728](https://github.com/nholuongut/commitlint/issues/3728)) ([22e6f74](https://github.com/nholuongut/commitlint/commit/22e6f74e3cae74497162c8ae8f5d3888e3b19f6e))
...
- update dependency semver to v7.3.6 ([#3112](https://github.com/nholuongut/commitlint/issues/3112)) ([ad886fd](https://github.com/nholuongut/commitlint/commit/ad886fd7ea46bc2df346099f9d4f10defd51fe75))
...
# [16.2.0](https://github.com/nholuongut/commitlint/compare/v16.1.0...v16.2.0) (2022-01-25)
...
## [16.0.1](https://github.com/nholuongut/commitlint/compare/v16.0.0...v16.0.1) (2021-12-28)
...
- **rules:** fix subject-full-stop rule config value type ([#2534](https://github.com/nholuongut/commitlint/issues/2534)) ([2ab3c57](https://github.com/nholuongut/commitlint/commit/2ab3c57b709ddad3fc98d768309ac4fdac8cb68a))
...
- add @lerna/project to repository dependencies ([#598](https://github.com/nholuongut/commitlint/issues/598)) ([56f03ee](https://github.com/nholuongut/commitlint/commit/56f03ee))
...
- slash in scope [#291](https://github.com/nholuongut/commitlint/issues/291) ([#529](https://github.com/nholuongut/commitlint/issues/529)) ([b2b63e5](https://github.com/nholuongut/commitlint/commit/b2b63e5))
...
- **rule-header-length:** show current header length ([6d61c4f](https://github.com/nholuongut/commitlint/commit/6d61c4f))
...
- correction to need help link ([#540](https://github.com/nholuongut/commitlint/issues/540)) ([fa6168a](https://github.com/nholuongut/commitlint/commit/fa6168a))
...
- move loadsh to dependencies ([1bb66a4](https://github.com/nholuongut/commitlint/commit/1bb66a4))
...
- **format:** add new line to result ([#518](https://github.com/nholuongut/commitlint/issues/518)) ([f1d443b](https://github.com/nholuongut/commitlint/commit/f1d443b)), closes [#504](https://github.com/nholuongut/commitlint/issues/504)
- add fallback with husky git params to deprecation handling ([#498](https://github.com/nholuongut/commitlint/issues/498)) ([5a34b8c](https://github.com/nholuongut/commitlint/commit/5a34b8c))
- avoid truncated output on macOS ([#503](https://github.com/nholuongut/commitlint/issues/503)) ([3192368](https://github.com/nholuongut/commitlint/commit/3192368))
- fall back to conventional commit-parser settings for missing keys ([#496](https://github.com/nholuongut/commitlint/issues/496)) ([831a141](https://github.com/nholuongut/commitlint/commit/831a141)), closes [#399](https://github.com/nholuongut/commitlint/issues/399)
- respect String.protoype.repeat API contract ([f27e7ac](https://github.com/nholuongut/commitlint/commit/f27e7ac))
...
- check stage before entering prompt ([#495](https://github.com/nholuongut/commitlint/issues/495)) ([3b3667a](https://github.com/nholuongut/commitlint/commit/3b3667a)), closes [#51](https://github.com/nholuongut/commitlint/issues/51) [#51](https://github.com/nholuongut/commitlint/issues/51)
- warn on empty config ([#491](https://github.com/nholuongut/commitlint/issues/491)) ([b6bd36e](https://github.com/nholuongut/commitlint/commit/b6bd36e)), closes [#107](https://github.com/nholuongut/commitlint/issues/107) [#107](https://github.com/nholuongut/commitlint/issues/107)
...
- ignore merge messages with text after newline ([b32bc93](https://github.com/nholuongut/commitlint/commit/b32bc93))
- use grouped regex to ignore merge commits ([#439](https://github.com/nholuongut/commitlint/issues/439)) ([905e9d5](https://github.com/nholuongut/commitlint/commit/905e9d5))

### Features

- **cli:** add format option for report output ([1ecf097](https://github.com/nholuongut/commitlint/commit/1ecf097))
...
- **wildcards:** add new wildcard patterns [#315](https://github.com/nholuongut/commitlint/issues/315) ([e9ea17f](https://github.com/nholuongut/commitlint/commit/e9ea17f))
...
- print commit message when the message is invalid ([86c34f1](https://github.com/nholuongut/commitlint/commit/86c34f1)), closes [#222](https://github.com/nholuongut/commitlint/issues/222)
...
- **ensure:** ignore word delimiters for case matching [#291](https://github.com/nholuongut/commitlint/issues/291) ([fa69299](https://github.com/nholuongut/commitlint/commit/fa69299))
...
- **parse:** default to angular preset for empty parserOpts ([#265](https://github.com/nholuongut/commitlint/issues/265)) ([ccb03b4](https://github.com/nholuongut/commitlint/commit/ccb03b4)), closes [#262](https://github.com/nholuongut/commitlint/issues/262)

### Features

- add "--config" option ([#261](https://github.com/nholuongut/commitlint/issues/261)) ([2c03ec6](https://github.com/nholuongut/commitlint/commit/2c03ec6))
...
- update dependency cosmiconfig to ^4.0.0 ([#234](https://github.com/nholuongut/commitlint/issues/234)) ([7f94ac5](https://github.com/nholuongut/commitlint/commit/7f94ac5))
- update dependency semver to v5.5.0 ([#236](https://github.com/nholuongut/commitlint/issues/236)) ([6c52bd9](https://github.com/nholuongut/commitlint/commit/6c52bd9))
...
- ignore branch merges with multiple newlines ([#227](https://github.com/nholuongut/commitlint/issues/227)) ([1f0c5ca](https://github.com/nholuongut/commitlint/commit/1f0c5ca))
...
- allow [0] shorthand ([84cf938](https://github.com/nholuongut/commitlint/commit/84cf938))
- correctly resolve parserOpts [#115](https://github.com/nholuongut/commitlint/issues/115) [#95](https://github.com/nholuongut/commitlint/issues/95) ([1353dd5](https://github.com/nholuongut/commitlint/commit/1353dd5))
- ignore branch merges with newlines ([#214](https://github.com/nholuongut/commitlint/issues/214)) ([c94c4dc](https://github.com/nholuongut/commitlint/commit/c94c4dc))
- sanitize ensure.case [#211](https://github.com/nholuongut/commitlint/issues/211) ([#217](https://github.com/nholuongut/commitlint/issues/217)) ([03aeefc](https://github.com/nholuongut/commitlint/commit/03aeefc))

### Styles

- validate rule configuration ([edf7187](https://github.com/nholuongut/commitlint/commit/edf7187))
...
## [5.2.6](https://github.com/nholuongut/commitlint/compare/v5.2.5...v5.2.6) (2017-12-21)

### Bug Fixes

- ignore semver commits with chore type ([cdbb085](https://github.com/nholuongut/commitlint/commit/cdbb085)), closes [#198](https://github.com/nholuongut/commitlint/issues/198)

<a name="5.2.5"></a>

## [5.2.5](https://github.com/nholuongut/commitlint/compare/v5.2.4...v5.2.5) (2017-12-08)

### Bug Fixes

- **core:** use correct report message [#192](https://github.com/nholuongut/commitlint/issues/192) ([e3a78bc](https://github.com/nholuongut/commitlint/commit/e3a78bc))

<a name="5.2.4"></a>

## [5.2.4](https://github.com/nholuongut/commitlint/compare/v5.2.3...v5.2.4) (2017-12-08)

**Note:** Version bump only for package @commitlint/root

<a name="5.2.3"></a>

## [5.2.3](https://github.com/nholuongut/commitlint/compare/v5.2.2...v5.2.3) (2017-12-05)

### Bug Fixes

- **cli:** add support for GIT_PARAMS on windows ([c62bd41](https://github.com/nholuongut/commitlint/commit/c62bd41)), closes [#103](https://github.com/nholuongut/commitlint/issues/103) [#175](https://github.com/nholuongut/commitlint/issues/175)

<a name="5.2.2"></a>

## [5.2.2](https://github.com/nholuongut/commitlint/compare/v5.2.1...v5.2.2) (2017-11-30)

### Bug Fixes

- **travis-cli:** read push commits directly ([9bc56c6](https://github.com/nholuongut/commitlint/commit/9bc56c6))

<a name="5.2.1"></a>

## [5.2.1](https://github.com/nholuongut/commitlint/compare/v5.2.0...v5.2.1) (2017-11-30)

### Bug Fixes

- **travis-cli:** lint ranges only for pr builds ([85b201f](https://github.com/nholuongut/commitlint/commit/85b201f))

<a name="5.2.0"></a>

# [5.2.0](https://github.com/nholuongut/commitlint/compare/v5.1.3...v5.2.0) (2017-11-30)

### Bug Fixes

- consider pull requests from forks ([4653c2c](https://github.com/nholuongut/commitlint/commit/4653c2c))

### Features

- **babel-preset-commitlint:** add jsx tranform ([#163](https://github.com/nholuongut/commitlint/issues/163)) ([5190241](https://github.com/nholuongut/commitlint/commit/5190241))

<a name="5.1.3"></a>

## [5.1.3](https://github.com/nholuongut/commitlint/compare/v5.1.2...v5.1.3) (2017-11-24)

### Bug Fixes

- **config-conventional:** add missing applicable attribute to type-enum ([a8db0b1](https://github.com/nholuongut/commitlint/commit/a8db0b1))

<a name="5.1.2"></a>

## [5.1.2](https://github.com/nholuongut/commitlint/compare/v5.1.1...v5.1.2) (2017-11-24)

### Bug Fixes

- **prompt:** apply forced cases properly ([3a569a7](https://github.com/nholuongut/commitlint/commit/3a569a7)), closes [#145](https://github.com/nholuongut/commitlint/issues/145)
...
- set access for npm ([8aeaec2](https://github.com/nholuongut/commitlint/commit/8aeaec2))
...
- update dependency concurrently to v3.5.1 ([#147](https://github.com/nholuongut/commitlint/issues/147)) ([a809d0f](https://github.com/nholuongut/commitlint/commit/a809d0f))
- **config-conventional:** remove unneeded dependency ([d0e62fd](https://github.com/nholuongut/commitlint/commit/d0e62fd))

### Features

- **prompt:** add description for build, ci and revert ([#148](https://github.com/nholuongut/commitlint/issues/148)) ([ee6ec6e](https://github.com/nholuongut/commitlint/commit/ee6ec6e))
- **travis-cli:** add reusable travis command line interface ([3e6e6a8](https://github.com/nholuongut/commitlint/commit/3e6e6a8))
- add nholuongut package ([8bb0a85](https://github.com/nholuongut/commitlint/commit/8bb0a85))
...
- **core:** fall back to globally installed config if available ([#127](https://github.com/nholuongut/commitlint/issues/127)) ([8612eb3](https://github.com/nholuongut/commitlint/commit/8612eb3))

<a name="5.0.0"></a>

# [5.0.0](https://github.com/nholuongut/commitlint/compare/v4.3.0...v5.0.0) (2017-11-18)
...
# [4.3.0](https://github.com/nholuongut/commitlint/compare/v4.2.2...v4.3.0) (2017-11-08)

### Bug Fixes

- **core:** deprecate nlp rules ([bbab1d8](https://github.com/nholuongut/commitlint/commit/bbab1d8)), closes [#54](https://github.com/nholuongut/commitlint/issues/54)
- **core:** ignore comments ([f3beda1](https://github.com/nholuongut/commitlint/commit/f3beda1)), closes [#78](https://github.com/nholuongut/commitlint/issues/78)

### Features

- add references-empty rule ([4fc8d5d](https://github.com/nholuongut/commitlint/commit/4fc8d5d))
