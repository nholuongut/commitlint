...
Common types according to [commitlint-config-conventional (based on the Angular convention)](https://github.com/nholuongut/commitlint/tree/master/@commitlint/config-conventional#type-enum) can be:
...
> **Ideas**: [nholuongut/commitlint#94](https://github.com/nholuongut/commitlint/issues/94)
...
| -------------------------------------------------------------------------------- | --------------- |
| [v19](https://github.com/nholuongut/commitlint/releases/tag/v19.0.0) | 02/2024         |
| [v18](https://github.com/nholuongut/commitlint/releases/tag/v18.0.0) | 10/2023         |
...
- [nholuongut](https://github.com/nholuongut/nholuongut)
...
```sh
git clone git@github.com:nholuongut/commitlint.git
cd commitlint
yarn
...
[4]: https://github.com/nholuongut/commitlint/actions/workflows/CI.yml/badge.svg
[5]: https://github.com/nholuongut/commitlint/actions/workflows/CI.yml
